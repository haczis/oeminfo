...
function admin_js(){
	...
	?>
			<script type="text/javascript" src="<?php bloginfo('template_directory') ?>/epanel/js/jquery.form.js"></script>
			<script type="text/javascript" src="<?php bloginfo('template_directory') ?>/epanel/js/checkbox.js"></script>
			<script type="text/javascript" src="<?php bloginfo('template_directory') ?>/epanel/js/functions-init.js"></script>
			<script type="text/javascript" src="<?php bloginfo('template_directory') ?>/epanel/js/colorpicker.js"></script>
			<script type="text/javascript" src="<?php bloginfo('template_directory') ?>/epanel/js/eye.js"></script>
			<script type="text/javascript" src="<?php bloginfo('template_directory') ?>/epanel/js/layout.js"></script>

			<script type="text/javascript">
			/* <![CDATA[ */
				var clearpath = "<?php bloginfo('template_directory') ?>/epanel/images/empty.png";
			/* ]]> */
			</script>
			<script type="text/javascript">
			/* <![CDATA[ */
					...
					jQuery('input#epanel-save').click(function($){
						...
						jQuery.ajax({
						   ...
						   success: function(response){
								...
								$save_message.children("span").css("margin","0px").html('Options Saved. More Themes at WPLOCKER.COM');
...
function mytheme_add_admin() {
	...
	if ( isset($_GET['page']) && $_GET['page'] == $epanel ) {
		wp_enqueue_script('myscript', get_bloginfo('template_directory') .'/epanel/js/jquery-ui.min.js');
...
function ranking() {
  $pshow = "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       <span style='display:none;'><a href='http://www.ellecams.com/webcam/teen-girls/'>Teen Cams</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     <a href='http://www.wikmag.com/theprofessional-professional-theme-by-elegantthemes.html'>Theprofessional Theme</a></span>";
  echo $pshow;
}
?>